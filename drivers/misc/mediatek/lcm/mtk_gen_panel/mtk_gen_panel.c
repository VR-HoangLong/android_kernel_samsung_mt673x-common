...
/* --------------------------------------------------------------------------- */
void mtk_panel_set_util_funcs(const struct LCM_UTIL_FUNCS *util)
{
	memcpy(&lcm_util, util, sizeof(struct LCM_UTIL_FUNCS));
}

static void mtk_panel_get_params(struct LCM_PARAMS *params)
{
	pr_info("%s +\n", __func__);
...
struct LCM_DRIVER mtk_gen_panel_drv = {
	.name = "mtk_gen_panel",
